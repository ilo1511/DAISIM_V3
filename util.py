...
def printSummary(x, eth_price, dai_price, rho, risk_param, herd_param):
    print("============= Summary ==============")
    print("Risk Averseness : %.4f" % risk_param)
    print("Herding         : %.4f" % herd_param)
    print("Holdings in USD : %.4f" % (x[0] + x[1] * eth_price + x[2] * dai_price + x[3] * eth_price))
    print("Debt in USD     : %.4f" % (x[3] * eth_price / dai_price / rho))
    print("====================================")


def printColAssets(x_old, x, eth_price, dai_price, rho, risk_param, herd_param):
    print("========= Assets Change ============")
